...
* 테스트 대상에 테스트 케이스와 테스트 메서드를 추가해서 코드가 예상대로 잘 작동하는지 확인한다.
...
### Results
* 실제 값과 테스트 값이 일치하여 성공한 모습 <br>
<img src="https://user-images.githubusercontent.com/62936197/161071117-3cdc794c-c434-45c7-9962-be77b113b7d8.png" width="550" height="150"> 　
* 실제 값과 테스트 값이 일치하지 않아 실패한 모습 (description을 통해 어떤 부분에서 실패했는지 알려준다.) <br>
<img src="https://user-images.githubusercontent.com/62936197/161071130-afb6882b-44bb-4932-9494-c23f9cddac08.png" width="550" height="270"> 　
